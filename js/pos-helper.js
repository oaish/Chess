...
const getKingMoves = (sq) => {
    ...
    if (arr[sq - 11] === P.EMPTY || PieceCol[arr[sq]] !== PieceCol[arr[sq - 11]]) pos.push(sq - 11)
    if (arr[sq - 10] === P.EMPTY || PieceCol[arr[sq]] !== PieceCol[arr[sq - 10]]) pos.push(sq - 10)
    if (arr[sq - 9] === P.EMPTY || PieceCol[arr[sq]] !== PieceCol[arr[sq - 9]]) pos.push(sq - 9)

    if (arr[sq + 1] === P.EMPTY || PieceCol[arr[sq]] !== PieceCol[arr[sq + 1]]) pos.push(sq + 1)
...
const getBishopMoves = (sq) => {
    ...
    while (true) {
        ...
        if (arr[x] === 100 || PieceCol[arr[x]] !== CLR.BOTH) {
            if (arr[x] !== 100 && PieceCol[arr[x]] !== PieceCol[arr[sq]]) {
                if (count === 1)
                    diag.push(x)
                else if (count === 2)
                    diag.push(x)
